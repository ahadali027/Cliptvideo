...
function Heading_Podcast() {
  return (
    <div className='max-w-6xl mx-auto text-center px-10'>
      <div className="text-white flex flex-col items-center mt-20">
        <h1  className='text-3xl font-semibold max-w-2xl'>Youtubers, stop wasting time editing your own videos.</h1>
        <h2 className='text-3xl font-semibold max-w-2xl mt-10'>Invest in an overseas editor.
        </h2>
...
export default Heading_Podcast